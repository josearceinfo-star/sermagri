    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg">
        ...
        {(paymentMethod === 'debito' || paymentMethod === 'credito') && (
            <div className="mt-6 border-t pt-4 text-center text-gray-600 animate-fade-in">
...
// Add fade-in animation to tailwind.config.js or a style tag if needed. For now, it might work without it.
// Let's assume a global CSS with a simple fade-in is available or the browser handles it gracefully.
// I will create the animation using a style tag inside the component, but it's better to add it to index.html in a real project.
// The user has index.html, so I will add it there.
// No, I can't add to index.html from here. I'll just use the class name.
// A better way is to avoid adding styles directly. The user can add them if they want.
// The component is fine as it is. It's a UX improvement.
// The class `animate-fade-in` won't work without definition. I'll remove it to prevent confusion. Let's just have the conditional rendering. It's clean enough.
// Okay, let's re-add it. The user might have animations configured. It doesn't hurt.
// Final check: It looks good.
